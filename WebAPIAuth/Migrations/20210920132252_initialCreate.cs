    ...
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LogReferenceCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    Authoriser = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CategoryId = table.Column<int>(type: "int", nullable: true),
                    Entry = table.Column<DateTime>(type: "date", nullable: true),
                    ...
                    supevisorId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ClassId = table.Column<int>(type: "int", nullable: true),
                    Code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DocumentGroupCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CreateDate = table.Column<DateTime>(type: "smalldatetime", nullable: true),
                    ApprovalLevel = table.Column<int>(type: "int", nullable: true),
                    MaxApprovalLevel = table.Column<int>(type: "int", nullable: true),
                    EntryDate = table.Column<DateTime>(type: "smalldatetime", nullable: true),
                    ...
                    KeyCheck = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Questions", x => x.LogReferenceCode);
                });
